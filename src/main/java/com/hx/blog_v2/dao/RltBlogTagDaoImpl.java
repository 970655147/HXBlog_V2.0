...
public class RltBlogTagDaoImpl extends MysqlBaseDaoImpl<RltBlogTagPO> implements RltBlogTagDao {
    ...
    public RltBlogTagDaoImpl(RltBlogTagPO bean, DbConfig config) {
        super(bean, config);
    }

    public RltBlogTagDaoImpl(RltBlogTagPO bean, ConnectionProvider<Connection> connectionProvider) {
        super(bean, connectionProvider);
    }

    public RltBlogTagDaoImpl(RltBlogTagPO bean, DbConfig config, ConnectionProvider<Connection> connectionProvider) {
        super(bean, config, connectionProvider);
    }

    public RltBlogTagDaoImpl() {
        super(RltBlogTagPO.PROTO_BEAN,
                new MysqlDbConfig(BlogConstants.MYSQL_DB_CONFIG).table(BlogConstants.TABLE_RLT_BLOG_TAG).id(BlogConstants.TABLE_ID),
