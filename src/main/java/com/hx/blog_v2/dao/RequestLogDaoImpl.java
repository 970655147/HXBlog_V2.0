...
public class RequestLogDaoImpl extends MysqlBaseDaoImpl<RequestLogPO> implements RequestLogDao {
    ...
    public RequestLogDaoImpl(RequestLogPO bean, DbConfig config) {
        super(bean, config);
    }

    public RequestLogDaoImpl(RequestLogPO bean, ConnectionProvider<Connection> connectionProvider) {
        super(bean, connectionProvider);
    }

    public RequestLogDaoImpl(RequestLogPO bean, DbConfig config, ConnectionProvider<Connection> connectionProvider) {
        super(bean, config, connectionProvider);
    }

    public RequestLogDaoImpl() {
        super(RequestLogPO.PROTO_BEAN,
                new MysqlDbConfig(BlogConstants.MYSQL_DB_CONFIG).table(BlogConstants.TABLE_REQUEST_LOG).id(BlogConstants.TABLE_ID),
