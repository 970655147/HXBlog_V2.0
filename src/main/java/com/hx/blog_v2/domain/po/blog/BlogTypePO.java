 ...
 */
public class BlogTypePO extends BasePO implements JSONTransferable<BlogTypePO>, Comparable<BlogTypePO>, LogisticalId<String> {
    ...
    @Override
    public BlogTypePO loadFromJSON(Map<String, Object> obj, JSONConfig config) {
        if (Tools.isEmpty(obj)) {
            return this;
        }

        JSONObject.fromObject(obj).toBean(BlogTypePO.class, this, config);
        return this;
    }
