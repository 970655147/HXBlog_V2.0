...
public class RolePO implements JSONTransferable<RolePO>, Comparable<RolePO> {
    ...
    public static final RolePO PROTO_BEAN = new RolePO();

    @Override
    public RolePO loadFromJSON(Map<String, Object> obj, JSONConfig config) {
        if (Tools.isEmpty(obj)) {
            return this;
        }

        JSONObject.fromObject(obj).toBean(RolePO.class, this, config);
        return this;
    }
    ...
    @Override
    public RolePO newInstance(Object... args) {
        return new RolePO();
    }
