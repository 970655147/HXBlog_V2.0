...
public class ActionEnter {
	...
	public ActionEnter ( HttpServletRequest request, String rootPath ) {
		...
		this.actionType = (String) request.getAttribute( Constants.ACTION );
	...
	public String exec () {
		String callbackName = this.request.getParameter(Constants.CALLBACK);
...
//			case ActionMap.UPLOAD_FILE:
			...
			case ActionMap.UPLOAD_IMAGE_MULTI_DPI :
				conf = this.configManager.getConfig( actionCode );
				state = new ImageMultiDpiUploader( request, conf ).doExec();
				break ;
