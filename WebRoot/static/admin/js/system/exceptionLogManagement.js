...
layui.define(['element', 'laypage', 'layer', 'form', 'pagesize'], function (exports) {
    ...
    function doSearch(layer, index, pageNow) {
        ...
        ajax({
            url: reqMap.log.exceptionLogList,
            type: "GET",
            data: params,
    ...
    var funcs = {
        viewData: function (item) {
            ...
            html.append('<label class="layui-form-label" style="border: none" >id:</label>')
            html.append('<input style="width:87%;margin: auto;color: #000!important;" value="' + item.id + '" class="layui-input" readonly >')
            html.append('<label class="layui-form-label" style="border: none" >url:</label>')
            html.append('<input style="width:87%;margin: auto;color: #000!important;" name="url" value="' + item.url + '" class="layui-input" readonly >')
            html.append('<label class="layui-form-label" style="border: none" >handler:</label>')
            ...
            html.append('<label class="layui-form-label" style="border: none" >参数列表:</label>')
            ...
            html.append('<label class="layui-form-label" style="border: none" >异常信息:</label>')
            ...
            // html.append('<label class="layui-form-label" style="border: none" >开销时间:</label>')
            // html.append('<input style="width:87%;margin: auto;color: #000!important;" name="cost" value="' + item.cost + '" class="layui-input" readonly >')
            html.append('<label class="layui-form-label" style="border: none" >用户:</label>')
            html.append('<input style="width:87%;margin: auto;color: #000!important;" name="name" value="' + item.name + '" class="layui-input" readonly >')
            html.append('<label class="layui-form-label" style="border: none" >邮箱:</label>')
            html.append('<input style="width:87%;margin: auto;color: #000!important;" name="email" value="' + item.email + '" class="layui-input" readonly >')
            html.append('<label class="layui-form-label" style="border: none" >ip:</label>')
            html.append('<input style="width:87%;margin: auto;color: #000!important;" name="ip" value="' + item.requestIp + '" class="layui-input" readonly >')
            html.append('<label class="layui-form-label" style="border: none" >是否是系统用户:</label>')
            ...
            html.append('<label class="layui-form-label" style="border: none" >创建时间:</label>')
